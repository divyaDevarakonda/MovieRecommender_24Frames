...
<header class="w3-container  w3-center" style="padding:20px 16px">
  ...
  <h3 >Choose an Actor or Director to view their top movies by audience score</h3>
     <div id="moviesByScore" style="width:700px;height:500px;overflow-x:scroll">
   <s:form action="popularActorDirector">
   <table>
    	<tr>
    	<s:select label="Select Actor/Director:"
	headerKey="-1" headerValue="select"
	list="#{'actor':'Actor', 'director':'Director'}"
	name="selectedValue" />
		</tr>
		<tr>
		<td><s:textfield label="Enter movie number" name="userInputk"/>
...
<tr>
  <td style="width:100px"><s:property/></td>
  <%-- <td style="width:60px"><s:property/></td>
  <td style="width:60px"><s:property/></td>  
  <td style="width:130px;height:170px;background-image:url(<s:property/>)"></td>
  <td style="width:130px;height:170px;background-image:url(<s:property/>)"></td> --%>
</tr>
</s:iterator>
</table>
