...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="/MovieRecommender_24Frames/template.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Link 1</a>
...
<a href="/MovieRecommender_24Frames/popularDirectorActor.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Link 3</a>    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Link 4</a>
  </div>
